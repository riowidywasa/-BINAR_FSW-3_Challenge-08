...
const mockUser = {
    id: 1,
    name: 'Aku',
    email: new Date().getSeconds() + '@gmail.com',
    password: '1234567',
    image: 'gambar_dah',
    roleId: 1,
};
...
const mockUserModel = {
    ...
    create: jest.fn().mockReturnValue(defaultMockResp),
};
const mockRoleModel = {
...
describe('AuthenticationController', () => {
    describe('#encryptPassword', () => {
        it('should return valid bcrypt hashed password string', () => {
            const mockPass = 'siappp' + generateRandomNum();
    ...
    describe('#verifyPassword', () => {
        it('should return true if hash and pass match.', () => {
            const mockPass = 'please' + generateRandomNum();
    ...
    describe('#handleLogin', () => {
        it('should res.status(201) and return access token if login valid',
            async () => {
                ...
                const expectedToken = controller.createTokenFromUser(
                    { ...defaultMockResp, Role: mockRole }, mockRole,
                );
    ...
    describe('authorize', () => {
        ...
        it('should res.status(401) with InsufficientAccessError if token valid but role invalid.'
            , async () => {
                const roleModel = Role;
                const userModel = User;
                const controller = new AuthenticationController({
    ...
    describe('#handleGetUser', () => {
        ...
        it('should res.status(404) with RecordNotFoundError if user not found.',
            async () => {
                const mockReq = {
                    user: mockUser,
                };
        ...
        it('should res.status(404) with RecordNotFoundError if role not found.',
            async () => {
                const mockReq = {
                    user: mockUser,
                };
